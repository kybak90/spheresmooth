...
load("./work/apw/apw_spherical.Rdata")
...
#debugonce(penalized_linear_spherical_spline)
...
worldmap
ggsave(worldmap, file='map_fitted_apw.png', dpi = 300, width = 15, height = 15, units = "cm", bg = "transparent")
...
zoommap
ggsave(zoommap, file='map_fitted_apw_zoomed.png', dpi = 300, width = 17, height = 15, units = "cm", bg = "transparent")
